        ...
        <div className='information'>
          ...
          <div className='clubs'>
            ...
            <div className='clubs-logos'>
              <a href='https://www.instagram.com/sfu_ta/' target='_blank' rel="noopener noreferrer"><img className='logos' src={SFUTAPath} alt='SFUTA' width='100' height='100'/></a>
              <a href='https://www.instagram.com/ubcta/' target='_blank' rel="noopener noreferrer"><img className='logos' src={UBCTAPath} alt='UBCTA' width='100' height='100'/></a>
              <a href='https://www.instagram.com/tgsavancouver/' target='_blank' rel="noopener noreferrer"><img className='logos' src={TGSAPath} alt='TGSA' width='100' height='100'/></a>
            </div>
          </div>
        </div>
      </main>
